        ...
        <>
            <Col className='col-md-8 col-lg-8'>
                <div className='left-main d-flex flex-column '>
                    ...
                    <div className='d-flex justify-content-between bg-secondary-light p-2'>
                        <div className='align-self-center text-white'><p className='bg-dark p-1 rounded'>1</p></div>
                        <div className='align-self-center'><p htmlFor=""><strong>JOHN DOE</strong></p></div>
                        <div className='align-self-center'><p htmlFor="">JOHNDOE@EXAMPLE.COM</p></div>
                    </div>

                    <div className='d-flex  bg-secondary-light my-1 p-2 flex-column'>
                        <div className='d-flex justify-content-between '>
                            <div className='text-white '><p className='bg-dark p-1 rounded'>2</p></div>
                            <div className=''><p htmlFor=""><strong>Order And Delivery Details</strong></p></div>
                        </div>
                        ...
                        <div className='d-flex justify-content-between p-2'>
                            ...
                            <div className='align-self-center'>
                                ...
                                <p htmlFor=""><strong>Sat, 7 Aug, 2022</strong></p>
            ...
            <Col>
                <div className='right-main d-flex flex-column bg-secondary-light p-3'>
                    <div className=''>
                        <div>
                            <p htmlFor=""><strong>Price Details</strong></p>
                        </div>
                    </div>
                    <div className=''>
                        <div className='d-flex justify-content-between'>
